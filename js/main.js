                    ...
                    function get_balance() {
                        ...
                        */
                        ...
                        eosobject.getTableRows({
                            ...
                            BUYSOVEOSAVGPRICE.innerText = ("价格含滑点 = " + buysoveosAvgPrice + " EOS");
                            SELLSOVEOSAVGPRICE.innerText = ("价格含滑点 = " + sellsoveosAvgPrice + " EOS");
            
                            SOVEOSPRICE.innerText = ("SOV 价格 = " + soveosPrice + " EOS");
                        ...
                        eosobject.getTableRows({
                            ...
                            BUYSOVUSDTAVGPRICE.innerText = ("价格含滑点 = " + buysovusdtAvgPrice + " USDT");
                            SELLSOVUSDTAVGPRICE.innerText = ("价格含滑点 = " + sellsovusdtAvgPrice + " USDT");
            
                            SOVUSDTPRICE.innerText = ("SOV 价格 = " + sovusdtPrice + " USDT");
                        ...
                        eosobject.getTableRows({
                            ...
                            BUYSVXEOSAVGPRICE.innerText = ("价格含滑点 = " + buysvxeosAvgPrice + " EOS");
                            SELLSVXEOSAVGPRICE.innerText = ("价格含滑点 = " + sellsvxeosAvgPrice + " EOS");
            
                            SVXEOSPRICE.innerText = ("SVX 价格 = " + svxeosPrice + " EOS");
                        ...
                        eosobject.getTableRows({
                            ...
                            BUYEOSPBTCAVGPRICE.innerText = ("价格含滑点 = " + buyeospbtcAvgPrice + " pbtc");
                            SELLEOSPBTCAVGPRICE.innerText = ("价格含滑点 = " + selleospbtcAvgPrice + " pBTC");
            
                            EOSPBTCPRICE.innerText = ("EOS 价格 = " + eospbtcPrice + " pBTC");
                            ...
                            try {
                               ...
                               // document.getElementById("unstakingSlider").max = svxPowerAmount;
                                ...
                                if (parseFloat(svx_supply) > 0 && parseFloat(svxpower) > 0) {
                                    ...
                                    document.getElementById('svx_bonus').innerHTML = "<span class='bold' style='font-size:14px;'>抵押SVX的挖矿奖励: <span style='color:#00bb00'>" + bonus_percentage + "</span> %</span>";
                                ...
                                if (parseFloat(svx_supply) > 0 && parseFloat(svxpower) > 0) {
                                    ...
                                    document.getElementById('nodeRequirement').innerHTML = "<span class='bold' style='font-size:14px;'>抵押777k + SVX用于自动节点支付</span>";                                   
                                    
                                    document.getElementById('svxDiscount').innerHTML = "<span class='bold' style='font-size:14px;'>SVX抵押交易费折扣: <span style='color:#00bb00'>" + feeDiscount + "</span> %</span>";

                                    document.getElementById('resourcesInfo').innerHTML = "<span class='bold' style='font-size:14px;'>花SOV租用CPU，NET或购买RAM</span>";                                  
                                    ...
                                    document.getElementById('svxMiningRate').innerHTML = "<span class='bold' style='font-size:14px;'>每个单独的挖掘动作奖励： <span style='color:#00bb00'>" + mining_rate + "</span> SVX</span>";

                                    document.getElementById('totalSVXMiningRate').innerHTML = "<span class='bold' style='font-size:14px;'>交易总奖励： <span style='color:#00bb00'>" + total_mining_rate + "</span> SVX</span>";

                                    document.getElementById('sellsoveosMiningRateDiv').innerHTML = "<span class='bold' style='font-size:14px;'>奖励: <span style='color:#00bb00'>" + sellsoveosMiningRate + "</span>  SVX</span>";

                                    document.getElementById('buysoveosMiningRateDiv').innerHTML = "<span class='bold' style='font-size:14px;'>奖励: <span style='color:#00bb00'>" + buysoveosMiningRate + "</span>  SVX</span>";

                                    document.getElementById('sellsovusdtMiningRateDiv').innerHTML = "<span class='bold' style='font-size:14px;'>奖励: <span style='color:#00bb00'>" + sellsovusdtMiningRate + "</span>  SVX</span>";

                                    document.getElementById('buysovusdtMiningRateDiv').innerHTML = "<span class='bold' style='font-size:14px;'>奖励: <span style='color:#00bb00'>" + buysovusdtMiningRate + "</span>  SVX</span>";

            


                                    document.getElementById('svxMiningMultiplier').innerHTML = "<span class='bold' style='font-size:14px;'>挖矿乘数: <span style='color:orange'> " + mining_multiplier + "</span>";

                                    document.getElementById('svxMiningBurn').innerHTML = "<span class='bold' style='font-size:14px;'>每笔交易的总刻录量: <span style='color:red'> " + sovBurnAmount + "</span> SOV </span>";

                                    document.getElementById('svxMiningCost').innerHTML = "<span class='bold' style='font-size:16px;'>挖矿1 SVX会燃烧 <span> " + miningCost + "</span> SOV</span>";
                    ...
                    */
                    ...
                    window.dologout = async() => {
                        ...
                        try {
                            ...
                            document.getElementById('buttontext').innerHTML = "登录";
                            //        document.getElementById('scatterhint').style.visibility = "visible";
                        } catch (err) {
                    ...
                    const setStatus = () => {
                        ...
                        if (account != undefined) {
                            ...
                            document.getElementById('buttontext').innerHTML = "登出";

                            console.log(scatter_account + " 已登入");
...
function showVal(val) {
                        ...
                        document.getElementById('dotransaction_bundle').innerHTML = "矿 X " + val;
                    ...
                    function svx_to_stake_action() {
                        ...
                        eosobject.transaction({
                            ...
                            //  nalert('<br><div class=\'checkmark_red\'></div>Error '+err.error.name+ '!<br><br>','white');
                            alert('误差: ' + err.error.details[0].message);
                    ...
                    function svx_to_unstake_action() {
                     ...
                     function rentCPUSOV() {
                        ...
                        alert("转送 " + transfer_amount + " SOV租用CPU");
                    ...
                    function rentNETSOV() {
                        ...
                        var transfer_amount = document.getElementById('sovresourcesInput').value;
                        alert("转送 " + transfer_amount + " SOV租用NET");
                        transfer_amount = format_eos_amount(transfer_amount);
                        transfer_amount = transfer_amount + " SOV";
                    ...
                    function buyRAMSOV() {
                        ...
                        var transfer_amount = document.getElementById('sovresourcesInput').value;
                        alert("转送 " + transfer_amount + " SOV购买RAM");
                        transfer_amount = format_eos_amount(transfer_amount);
                        transfer_amount = transfer_amount + " SOV";
                    ...
                    function buySOVEOS() {
                        ...
                        alert("交换 " + transfer_amount + " EOS为SOV");
                        transfer_amount = format_eos_amount(transfer_amount);
                    ...
                    function sellSOVEOS() {
                        ...
                        alert("交换 " + transfer_amount + " SOV为EOS");
                        transfer_amount = format_eos_amount(transfer_amount);
                        transfer_amount = transfer_amount + " SOV";
                    ...
                    function buySVXEOS() {
                        ...
                        alert("交换 " + transfer_amount + " EOS为SVX");
                        transfer_amount = format_eos_amount(transfer_amount);
                        transfer_amount = transfer_amount + " EOS";
                    ...
                    function sellSVXEOS() {
                        ...
                        alert("交换 " + transfer_amount + " SVX为EOS");
                        transfer_amount = format_eos_amount(transfer_amount);
                    ...
                    function buySOVUSDT() {
                        ...
                        alert("交换 " + transfer_amount + " USDT为SOV");
                        transfer_amount = format_eos_amount(transfer_amount);
                    ...
                    function sellSOVUSDT() {
                        ...
                        alert("交换 " + transfer_amount + " SOV为USDT");
                        transfer_amount = format_eos_amount(transfer_amount);
                        transfer_amount = transfer_amount + " SOV";
                    ...
                    function buyEOSPBTC() {
                        ...
                        alert("交换 " + transfer_amount + " pBTC为EOS");
                    ...
                    function sellEOSPBTC() {
                        ...
                        alert("交换 " + transfer_amount + " EOS为pBTC");
                        transfer_amount = format_eos_amount(transfer_amount);
                        transfer_amount = transfer_amount + " EOS";
